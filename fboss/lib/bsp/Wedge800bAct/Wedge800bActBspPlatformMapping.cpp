...
static BspPlatformMappingThrift buildWedge800bActPlatformMapping(
...
Wedge800bActBspPlatformMapping::Wedge800bActBspPlatformMapping()
    : BspPlatformMapping(
          buildWedge800bActPlatformMapping(kJsonBspPlatformMappingStr)) {}

Wedge800bActBspPlatformMapping::Wedge800bActBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(buildWedge800bActPlatformMapping(platformMappingStr)) {
}
